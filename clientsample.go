...
func exampleABIJsonToBin() {
	...
	res, err := makeRequest("POST", "/v1/eos/proxy/chain/abi_json_to_bin", params, &json)
...
func examplePostTransaction() {
	...
	res, err := makeRequest("POST", "/v1/eos/proxy/chain/push_transaction", params, &transaction)
